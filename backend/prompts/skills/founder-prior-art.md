...
people doing the thing you're thinking of. That should be step zero. Everybody
doesn't do that."

Most accelerators never ask this. Ours does, because our model can act on the
answer: a competitor can become a contributor without a cap-table fight, since
every share comes from work.

## What to do
1. **Search before concluding anything.** `abra_search` first, because the team
...
## Output
The list, one line each on what they do and how far along, every one linked, and
the founder's call beside it. Then the single next step.

## Don't
- Don't declare a space empty. If you found nothing, say exactly what you searched.
- Don't rank them as threats. The question is who to work with.
- Don't hand back a research report. They asked who is out there, not for a market survey.
